...
public class GroupmemberMapper {
	 ...
	 * nur eine einzige Instanz der GroupmemberMapper-Klasse existiert. Aufgerufen wird
	 * die Klasse somit über GroupmemberMapper.groupmemberMapper() und nicht über den
	 * New-Operator.
	 * 
	...
	public Vector<Groupmember> findAllByGroupID(Group g)  {
	  ...
	  public Groupmember insertGroupmember(Groupmember gm)  {
			...
			try { 
				// Prepared Statement erstellen um einen groupmember in die Datenbank einzufügen
				PreparedStatement insert = con
						.prepareStatement("INSERT INTO softwarepraktikum_ws1920.groupmember(groupID, userID) VALUES (?,?);");
				...
				PreparedStatement getnewGroup= con
						.prepareStatement("SELECT *FROM softwarepraktikum_ws1920.groupmember ORDER BY creationDate DESC LIMIT 1;");
				// Ergebnis-Tupel in Objekt umwandeln
	  ...
	  public void deleteGroupmemberByGroupmemberID(Groupmember gm) {
		  ...
		  try {
				...
				deleteByID.setInt(1, gm.getGroupID());
