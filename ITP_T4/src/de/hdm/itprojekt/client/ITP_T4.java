...
//	private final GreetingServiceAsync greetingService = GWT.create(GreetingService.class);
	...
	public void onModuleLoad() {
		...
		editorAdministration.getUserByEmail(currentUser, new AsyncCallback<User>() {
			...
			currentUser = result;
			editorAdministration.getAllGroupByUserID(currentUser, new AsyncCallback<Vector<Group>>() {
